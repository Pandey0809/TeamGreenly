...
def main(device: Device, *args, **kwargs) -> None:
    ...
    tap(device, 850, 1970, 5)
    write_text(device, "green321ly@gmail.com", 1)
    tap(device, 993, 2122, 1)
    tap(device, 661, 600, 1)
    write_text(device, "test greenly", 1)
    tap(device, 900, 170, 1)
